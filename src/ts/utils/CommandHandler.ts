    ...
    public executeCommand(command: ICommand): void {
        switch(command.command) {
            ...
            case CommandType.observe:
                if(this.player.location) {
                    this.outputHandler.println(200, `You observe the following items: ${this.player.location.getItemNames()} and ${this.player.location.getAmountOfAdjacentRooms()} door(s)`)
                } else {
